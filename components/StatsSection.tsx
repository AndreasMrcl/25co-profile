...
const stats = [
  { value: 500, suffix: "+", label: "Happy Visitors", desc: "Per bulan" },
  {
    ...
    suffix: "+",
    label: "Menu Kopi",
    desc: "Specialty & signatures",
  },
  {
    value: 4,
    suffix: " Lantai",
    label: "Ruang Tersedia",
    desc: "Indoor, outdoor, dan rooftop",
  },
...
export default function StatsSection() {
  ...
  return (
    ...
    >
      <div
        className="st-bg"
        style={{ position: "absolute", inset: 0, transform: "scale(1.12)" }}
      >
        <Image
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, rgba(26,16,8,0.92) 0%, rgba(45,35,24,0.88) 100%)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse at 80% 50%, rgba(184,134,92,0.15), transparent 60%)",
        }}
      />
      ...
      >
        ...
        >
          {stats.map((stat, i) => (
            <div
              ...
              style={{
                borderLeft: "1px solid rgba(184,134,92,0.3)",
                paddingLeft: "24px",
              }}
            >
              <div
        ...
        <div className="st-quote" style={{ maxWidth: "820px" }}>
          ...
          >
            "Tempat di mana ide-ide besar lahir, koneksi terjalin, dan kopi
            terbaik dinikmati."
          </blockquote>
          <cite
            style={{
          ...
          {[
            ...
            <span
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.color = "var(--muted-tan)";
              }}
              onMouseLeave={(e) => {
